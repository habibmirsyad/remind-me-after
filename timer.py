...
myTimeInputH = ttk.Combobox(frame1, values=varH, width=2)
myTimeInputH.current(0)
myTimeInputMin = ttk.Combobox(frame1, values=varMin, width=2)
myTimeInputMin.current(0)
myTimeInputSec = ttk.Combobox(frame1, values=varSec, width=2)
